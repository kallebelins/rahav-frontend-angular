...
export class NgPagination implements OnChanges {
    ...
    /**
     *  The number of data in your paginated collection.
     *
     *  Note, that this is not the number of pages. Page numbers are calculated dynamically based on
     *  `collectionSize` and `pageSize`. Ex. if you have 100 data in your collection and displaying 20 data per page,
    ...
    /**
     * Rotates page numbers based on maxSize data visible.
    ...
    /**
     * Paginates page numbers based on maxSize data per page.
     */
